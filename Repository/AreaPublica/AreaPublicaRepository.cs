...
namespace BoschCartaoDigitalBackEnd.Repository.AreaPublica
{
    public class AreaPublicaRepository
    {
        ...
        public async Task<Colaborador> BuscarIndicadoAsync(int idEvento, int idColaborador)
        {
            ...
            var indicado = await _db.Direito.Where(d => d.ColaboradorId == idColaborador && d.EventoId == idEvento && d.RetiradoId == null)
                .Include(d => d.Indicado).AsSplitQuery().FirstOrDefaultAsync();
